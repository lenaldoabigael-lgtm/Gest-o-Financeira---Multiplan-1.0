...
const Layout: React.FC<LayoutProps> = ({ user, activeTab, setActiveTab, onLogout, children }) => {
  const tabs = [
    ...
    { id: Tab.ESTRUTURA_PROPOSTA, label: 'Estrutura', icon: 'fa-folder-tree', permission: user.permissions.estruturaProposta },
    ...
    { id: Tab.FINANCEIRO, label: 'Financeiro', icon: 'fa-wallet', permission: user.permissions.financeiro },
