...
async function run() {
  const { data, error } = await supabase.from('transactions').insert({ comprovanteUrl: 'test', type: 'PAGAR', vencimento: '2026-07-14', descricao: 'test', valor: 10, formaPagamento: 'PIX', status: 'PENDENTE', centroCusto: 'test', subItem: 'test', conta: 'GERAL' });
